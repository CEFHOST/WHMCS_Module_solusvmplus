...
if ( $r["status"] == "success" ) {
    if ( $r["sessionactive"] == "1" ) {
        ...
        <div align="center"><p style="padding-bottom: 5px"><?php echo $_LANG['solusvmplus_password'] . ': ' . $r['consolepassword']; ?></p><br>
        ...
        <div class="row margin-10">
            ...
            <div class="col-xs-8">
                <form class="form-inline" method="post" name="createsession">
                    ...
                    <button name="sessioncreate" type="submit" class="btn btn-success"><?php echo $_LANG['solusvmplus_createSession']; ?></button>
                    <button type="button" class="btn btn-danger" onclick="window.close()"><?php echo $_LANG['solusvmplus_closeWindow']; ?></button>
                </form>
            </div>
            <div class="col-xs-2"></div>
        </div>
