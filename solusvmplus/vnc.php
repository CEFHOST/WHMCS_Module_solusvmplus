...
$params = SolusVMPlus::getParamsFromServiceID( $servid, $uid );
if ( $params === false ) {
...
if ( $r["status"] != "success" ) {
    $pagedata = '<div class="alert alert-danger">' . $_LANG['solusvmplus_unknownError'] . '</div>';
    echo $pagedata;
    echo '</body>';
    exit();
}
...
if ( $r["sockethost"] ) {
    $htmlvnc = '&nbsp;&nbsp;<input type="button" class="button" name="" id="" value="' . $_LANG['solusvmplus_HTMLVNC'] . '" onClick="window.location=\'vnc.php?id=' . $servid . '&_vnc=html\'"/>';
}
$javavnc = '&nbsp;&nbsp;<input type="button" class="button" name="" id="" value="' . $_LANG['solusvmplus_JavaVNC'] . '" onClick="window.location=\'vnc.php?id=' . $servid . '&_vnc=java\'"/>';
$buttons = '<div align="center">' . $javavnc . $htmlvnc . '<br><br><input type="button" class="button" name="" id="" value="' . $_LANG['solusvmplus_refresh'] . '" onClick="window.location=\'vnc.php?id=' . $servid . '&_vnc=java\'"/></div><br>';
if ( $_GET['_vnc'] == "java" ) {
...
<PARAM NAME="PASSWORD" VALUE="' . $r['vncpassword'] . '">' . $_LANG['solusvmplus_needsJavaPlugins'] . '<applet></applet>
</APPLET></div>';
    echo $pagedata;
    ...
    <head>
        ...
        -->
        <title><?php echo $_LANG['solusvmplus_noVNC']; ?></title>
    ...
    <div id="noVNC_screen">
                ...
                <tr>
                    <td>
                        <div id="noVNC_status"
                            ...
                            <?php echo $_LANG['solusvmplus_loading']; ?>
                        </div>
                    </td>
                    <td width="1%">
                        ...
                        <input type=button value="<?php echo $_LANG['solusvmplus_shutdown']; ?>"
                               id="xvpShutdownButton">
                        <input type=button value="<?php echo $_LANG['solusvmplus_reboot']; ?>"
                               id="xvpRebootButton">
                        <input type=button value="<?php echo $_LANG['solusvmplus_reset']; ?>"
                               id="xvpResetButton">
                        </span>
                        </div>
                    </td>
        ...
        <canvas id="noVNC_canvas" width="640px" height="20px">
            <?php echo $_LANG['solusvmplus_canvasNotSupported']; ?>
        </canvas>
    </div>
